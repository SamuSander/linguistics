...
var demographics = {
    ...
    `
    <br><br>
    <div class="instructions" style="padding: 30px; margin: 10px; font-size: 18px; width:800px; background-color: white; border-radius: 10px;">
...
<select class="large-select" id="ethnicity" required="required" name="ethnicity">
    ...
    <p>Haben Sie Kinder?<br>
    <select class="large-select" id="children" required="required" name="children" 
    onchange="checkChildren(this.value)">
        <option value=""></option>
        <option value="no">nein</option>
        <option value="yes">ja</option>
    </select>
    ...
    <div name="children-details-div" id="children-details-div" style="display:none;">
    <p>Anzahl der Kinder: <input class="large-input" type="number" id="children-number" required="required" name="children-number" style="width: 3em" onchange="createAgeInputs(this.value)"><br>
    <p>Alter der Kinder: <div id="children-ages-div"></div>
    </div>
