...
var rwtIntro = {
  ...
  <div style="display:flex; align-items:center;">
      <div class="instructions" style="padding-left: 40px;">
        In dem folgenden kurzen Experiment sollen Sie innerhalb eines Zeitfensters 
        von <b>zwei Minuten</b> so viele Wörter wie möglich tippen. 
        Dies wird zweimal durchgeführt: einmal für Wörter, 
        die mit einem bestimmten Buchstaben beginnen und einmal für Wörter, 
        die zu einer bestimmten Kategorie gehören.<br><br>
...
var rwtPorM = {
  ...
  preamble: function() {
    ...
    <br><br>
    <b>Gib so viele Wörter ein, die mit dem Buchstaben <span style="color: blue;">'${experimentConfig.PorM}'</span> beginnen.<br> Drücke nach jedem Wort die Eingabetaste.</b><br><br><br>`;
  },
  type: TextInputTrial,
  data: function() {
    return {
...
var rwtProfessionsorHobbies = {
  ...
  preamble: function() {
    ...
    <div align="center"><span style="font-size:50px" id="matrix-time">2:00</span></div>
    <br><br>
    <b>Gib so viele <span style="color: blue;">${experimentConfig.ProfessionsorHobbies}</span> ein.<br> Drücke nach jedem Wort die Eingabetaste.</b>
    <br>`
  },
  type: TextInputTrial,
  data: {
