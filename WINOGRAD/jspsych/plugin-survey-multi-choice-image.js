var jsPsychSurveyMultiChoiceImage = (function (jspsych) {
  'use strict';
      ...
      trial(display_element, trial) {
          ...
          html +=
              ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; text-align: left; }" +
                  ...
                  "label.jspsych-survey-multi-choice-text input[type='radio']"; // Took out: {margin-right: 1em;}
          html += "</style>";
          // show preamble text
          ...
          for (var i = 0; i < trial.questions.length; i++) {
              ...
              for (var j = 0; j < question.options.length; j++) {
                  ...
                  html += '<img src="'+question.options[j]+'" width="100px";/>'; // added
                  html += '<p align="center"><label class="jspsych-survey-multi-choice-text" for="' + input_id + '">';
                  html +=
                      '<input type="radio" name="' +
                          ...
                          required_attr +
                          "></input></p>";
                  html += '<p align="center">' + (j+1).toString() + '</label>'; // replaced question.options[j] with (j+1).toString()
                  html += "</div>";
              }
              html += "</div>";
          }
