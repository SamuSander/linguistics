...
var evalPvtPractice = {
  on_load: function() {
    disp = document.querySelector('.jspsych-display-element');
    // Clear the inline background style to revert to the CSS-defined background color
...
wrongPracticePVT = {
  ...
  stimulus:
  `<div class="instructions" style="max-width:${instructionsWidth}px;">
    Sorry, aber Sie müssen mindestens <b>2 von 3</b> Stoppuhren rechtzeitig stoppen!<br>
    Sie müssen jede Uhr innerhalb von ${lapseTime/1000} Sekunden stoppen, aber implausible 
    Reaktuonszeiten (< ${prematureTime/1000} s) zählen als Fehler! 
    Bitte versuchen Sie es noch einmal.<br><br>
  </div>`,
  choices: ['Neuer Versuch'],
